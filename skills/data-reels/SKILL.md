...
**Silph Scope / Instagram algorithm ranking of finished Reels:** use **`/instagram`** → **`high-retention-insight-reels-instagram`** (skip gate first, then DistScore = Hook+Tension+Share+Save). This skill's density/polish laws are craft guidance — do not let them alone decide “which Instagram Reel will travel farthest.”
