...
copyright: Public domain (US). Published 1918/1919/1920.
source: Transcription from Project Gutenberg eBook #37134; Gutenberg wrapper and trademark text omitted.
note: This is Strunk's original "little book," not the 4th edition revised by E. B. White (1999/2000, still copyrighted).
---

# The Elements of Style (1920)

Public-domain source text for `elements-of-style`. Open only when a rule in SKILL.md needs Strunk's original wording or examples.

Italics in the source are `_underscores_`; bold is `=equals=`.
