...
| Skill | Credit |
|-------|--------|
| **flutter** (hub) | Evan-Kim2028/agent-skills — routes to official flutter-* skills when present + bundled polish auditor |
| **flutter-pro-ux-review** | Original synthesis for agents. Progressive surface catalogs (touch, a11y, data, forms, scroll, feedback/async, platform, motion, perf). Rule themes shaped by public Flutter craft signals: Kamran Bekirov ([flutterpro.design](https://flutterpro.design) / [@kamranbekirovyz](https://x.com/kamranbekirovyz) micro-detail tips; his `kamranbekirovyz/skills` was WIP when first written), Andrea Bizzotto (production feature completeness), Mitch Koko (UI hygiene), Roaa Khaddam (animation craft), Ethiel Adisso (spring / interactive motion), Luke Pighetti (prod UX gotchas), plus supporting signals from Filip Hráček, Elvira Leveque, Mike Rydstrom, Majid Hajian. Skill-authoring practices aligned with [agentskills.io progressive disclosure](https://agentskills.io/skill-creation/best-practices). **Not** a copy of any third-party skill repo or a dump of flutterpro.design articles. Complements official Flutter/Dart agent skills rather than replacing them. |
